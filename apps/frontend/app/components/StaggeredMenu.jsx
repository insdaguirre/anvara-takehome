...
const blurStart = blurLayer ? Number(gsap.getProperty(blurLayer, 'xPercent')) : null;
...
const all = [...layers, blurLayer, panel].filter(Boolean);
closeTweenRef.current?.kill();
const offscreen = position === 'left' ? -100 : 100;
...
<div ref={blurLayerRef} className="sm-grainient-layer" aria-hidden="true">
...
<a className="sm-logo" aria-label="Go to home page" href="/">
<img
